...
GitHub limits each file to 2 GiB, so v0.3.3 is two zips. Download **both** from [v0.3.3](https://github.com/BazoukaJo/PersonalClipboard/releases/tag/v0.3.3) and unzip them into the **same** folder:

1. `PersonalClipboard-0.3.3-windows-x64.zip` — app
2. `PersonalClipboard-0.3.3-windows-x64-cuda12.zip` — CUDA 12 DLLs (`_internal\nvidia`)
...
| **Clips** | Clipboard history. Copy any complete entry. |
