...
_OUT = _ROOT / "release"
_APP = "PersonalClipboard-0.3.3-windows-x64.zip"
_CUDA = "PersonalClipboard-0.3.3-windows-x64-cuda12.zip"
_README = """PersonalClipboard v0.3.3

1. Unzip PersonalClipboard-0.3.3-windows-x64.zip
2. Unzip PersonalClipboard-0.3.3-windows-x64-cuda12.zip into the same folder
