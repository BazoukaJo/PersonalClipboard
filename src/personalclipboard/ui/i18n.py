...
_EN = {
    ...
    "input_tip": "Microphone for dictation and Meeting Record. Saved for the next launch.",
    "output_tip": "Speakers or headphones to capture for Meeting and Playback Record. Saved for the next launch.",
    "opacity": "Opacity",
...
_FR = {
    **_EN,
    ...
    "input_tip": "Microphone pour la dictée et Réunion. Mémorisé au prochain lancement.",
    "output_tip": "Haut-parleurs ou casque à capturer pour Réunion et Lecture. Mémorisé au prochain lancement.",
    "opacity": "Opacité",
...
_ES = {
    **_EN,
    ...
    "input_tip": "Micrófono para dictado y Reunión. Se guarda para el próximo inicio.",
    "output_tip": "Altavoces o auriculares a capturar para Reunión y Reproducción. Se guarda para el próximo inicio.",
    "opacity": "Opacidad",
