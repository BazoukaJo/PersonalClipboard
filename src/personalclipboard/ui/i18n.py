...
_EN = {
    ...
    "input": "Input",
    "output": "Output",
    "device_default": "Windows default",
    "input_tip": "Microphone for dictation and Meeting Record. Windows default plus every device Windows lists. Saved for the next launch.",
    "output_tip": "Speakers or headphones for Meeting and Playback Record. Windows default plus every device Windows lists. Saved for the next launch.",
    "opacity": "Opacity",
    ...
    "settings_tip": "Language, microphone, speakers, opacity, Whisper, corrector, idle-mic, and type-ahead.",
...
_FR = {
    **_EN,
    ...
    "input": "Entrée",
    "output": "Sortie",
    "device_default": "Défaut Windows",
    "input_tip": "Microphone pour la dictée et Réunion. Défaut Windows plus tous les appareils. Mémorisé au prochain lancement.",
    "output_tip": "Haut-parleurs ou casque pour Réunion et Lecture. Défaut Windows plus tous les appareils. Mémorisé au prochain lancement.",
    "opacity": "Opacité",
    ...
    "settings_tip": "Langue, micro, haut-parleurs, opacité, Whisper, correcteur, micro au silence, suggestions.",
...
_ES = {
    **_EN,
    ...
    "input": "Entrada",
    "output": "Salida",
    "device_default": "Predeterminado de Windows",
    "input_tip": "Micrófono para dictado y Reunión. Predeterminado de Windows y todos los dispositivos. Se guarda para el próximo inicio.",
    "output_tip": "Altavoces o auriculares para Reunión y Reproducción. Predeterminado de Windows y todos los dispositivos. Se guarda para el próximo inicio.",
    "opacity": "Opacidad",
    ...
    "settings_tip": "Idioma, micrófono, altavoces, opacidad, Whisper, corrector, micrófono en silencio y sugerencias.",
